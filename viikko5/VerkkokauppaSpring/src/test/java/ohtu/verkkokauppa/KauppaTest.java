...
public class KauppaTest {
    ...
    public void ostoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaan3() {
        ...
        // määritellään että tuote numero 1 on maito jonka hinta on 5 ja saldo 10
        when(varasto.saldo(1)).thenReturn(10);
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "piima", 10));
    ...
    public void ostoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaan4() {
        ...
        // määritellään että tuote numero 1 on maito jonka hinta on 5 ja saldo 10
        when(varasto.saldo(1)).thenReturn(10);
        when(varasto.saldo(0)).thenReturn(10);
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "maito", 5));
        when(varasto.haeTuote(2)).thenReturn(new Tuote(2, "piima", 10));
    ...
    public void ostoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaan6() {
        ...
        k.lisaaKoriin(1);
        k.lisaaKoriin(2);
        k.tilimaksu("pekka", "12345");// ostetaan tuotetta numero 1 eli maitoa
        ...
        @Test
    public void ostoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaan7() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
